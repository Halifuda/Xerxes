...
typedef enum {
  POLICY_WRITE_BACK,      //!< Initially, only write to cache
  POLICY_WRITE_THROUGH,   //!< Write to both cache and flash
} WRITE_POLICY;
...
class Config : public BaseConfig {
 private:
  ...
  WRITE_POLICY writePolicy;    //!< Default: POLICY_WRITE_THROUGH
